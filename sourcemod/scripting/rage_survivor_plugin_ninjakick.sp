...
public OnPluginStart() {
	...
	SetupSDKCall();
	l4d_jumper_force = CreateConVar("l4d_jumper_force", "200.0", " jump force [50.0, 200.0]");
	l4d_jumper_delay = CreateConVar("l4d_jumper_delay", "0.6", "[0.5, 3.0]");
	l4d_jumper_damage = CreateConVar("l4d_jumper_damage", "200.0", "damage to infected [50.0, 200.0]");
