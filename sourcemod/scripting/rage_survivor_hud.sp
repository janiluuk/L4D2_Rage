...
#define HUD_SPECIAL_TIMER0 1
#define HUD_SPECIAL_TIMER1 2
#define HUD_SPECIAL_TIMER2 3
#define HUD_SPECIAL_TIMER3 4

#define HUD_SPECIAL_MAPNAME 1
#define HUD_SPECIAL_MODENAME 2 
#define HUD_SPECIAL_COOLDOWN  3 
#define HUD_SPECIAL_ROUNDTIME 4
